...
let handleData = (data) =>{
    ...
    if(data.github){
        ...
        port_links.innerHTML += `
            <li class="list-group-item d-flex flex-column justify-content-between align-items-center p-3">
                ...
                <a class="mb-0 portfolio" href="${data.portfolio}">${data.portfolio}</a>
            </li>`
    }else{
        port_links.innerHTML = `
    ...
    role_interested.innerHTML = data.tec_non_tec;
    tec_interest.innerHTML = data.Technical_Interest;
    non_tec_interest.innerHTML = data.non_tec;
    programming_skills.innerHTML = data.tec_skills;
